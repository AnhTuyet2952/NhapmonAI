...
public class Puzzle {
	...
	public static final char[] operators = { 'l', 'r', 'u', 'd' };// dung de di chuyen sang trai, phai,len, xuong
	...
	public int computeH1(Node currentState) {
		...
		for (int row = 0; row < MAX_ROW; row++) {
			for (int col = 0; col < MAX_COL; col++) {
				int currentTile = currentState.getTile(row, col);
				int goalTile = goalState.getTile(row, col);
	...
	/**
	 * Phương thức này tạo ra và trả về danh sách các trạng thái kế tiếp mà bạn có thể đạt được 
	 * từ trạng thái hiện tại bằng cách sử dụng các phép toán di chuyển.
	 * @param currentState
	 * @param operator
	 * @return
	 */
